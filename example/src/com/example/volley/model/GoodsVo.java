...
public class GoodsVo implements Serializable {
	...
	public GoodsVo(DbGoods db) {
		this.goods_id = db.getGoods_id();
		this.cat_id = db.getCat_id();
		this.goods_sn = db.getGoods_sn();
		this.goods_name = db.getGoods_name();
		this.goods_name_style = db.getGoods_name_style();
		this.click_count = db.getClick_count();
		this.sales_count = db.getSales_count();
		this.brand_id = db.getBrand_id();
		this.provider_name = db.getProvider_name();
		this.goods_number = db.getGoods_number();
		this.goods_weight = db.getGoods_weight();
		this.market_price = db.getMarket_price();
		this.shop_price = db.getShop_price();
		this.promote_price = db.getPromote_price();
		this.promote_start_date = db.getPromote_start_date();
		this.promote_end_date = db.getPromote_end_date();
		this.warn_number = db.getWarn_number();
		this.keywords = db.getKeywords();
		this.goods_brief = db.getGoods_brief();
		this.goods_desc = db.getGoods_desc();
		this.goods_thumb = db.getGoods_thumb();
		this.goods_img = db.getGoods_img();
		this.original_img = db.getOriginal_img();
		this.is_real = db.getIs_real();
		this.extension_code = db.getExtension_code();
		this.is_on_sale = db.getIs_on_sale();
		this.is_alone_sale = db.getIs_alone_sale();
		this.is_shipping = db.getIs_shipping();
		this.integral = db.getIntegral();
		this.add_time = db.getAdd_time();
		this.sort_order = db.getSort_order();
		this.is_delete = db.getIs_delete();
		this.is_best = db.getIs_best();
		this.is_new = db.getIs_new();
		this.is_hot = db.getIs_hot();
		this.is_promote = db.getIs_promote();
		this.bonus_type_id = db.getBonus_type_id();
		this.last_update = db.getLast_update();
		this.goods_type = db.getGoods_type();
		this.seller_note = db.getSeller_note();
		this.give_integral = db.getGive_integral();
		this.rank_integral = db.getRank_integral();
		this.suppliers_id = db.getSuppliers_id();
		this.is_check = db.getIs_check();
		this.is_collect = db.getIs_collect();
		this.cart_rec_id = db.getCart_rec_id();
		this.cart_goods_number = db.getCart_goods_number();
		this.share_url = db.getShare_url();
		this.is_comment = db.getIs_comment();
	}

	public GoodsVo(ResponseGoods response) {
	...
	public int getGoods_buy_number() {
		return goods_buy_number;
	}

	public void setGoods_buy_number(int goods_buy_number) {
		this.goods_buy_number = goods_buy_number;
	}
